  ...
  return (
    <div className="container max-w-4xl py-16">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="lead">
          At Webulae, we take your privacy seriously. This Privacy Policy explains how we collect,
        ...
        <p>
          ...
          personal information, including encryption, firewalls, and secure server
          infrastructure.
        </p>
        ...
        <p>
          We use cookies and similar tracking technologies to improve our services and
          enhance your experience. You can control cookie settings through your browser
          preferences.
        </p>
