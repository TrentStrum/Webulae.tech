			...
			<div className="container mx-auto px-4 py-16">
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					<div>
						...
						<p className="text-lg text-muted-foreground mb-6">
							At Webulae, our mission is to empower businesses through innovative software
							solutions. We strive to deliver excellence in every project, ensuring our clients stay
