...
export function SignUp() {
	...
	return (
		<div className="w-full">
			<h2 className="font-bold text-xl text-foreground">Create Account</h2>
			<p className="text-muted-foreground text-sm max-w-sm mt-2">
				Sign up to get started with Webulae
			</p>
			...
			<form className="my-8" onSubmit={handleSubmit}>
				<div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
					...
					<LabelInputContainer>
						...
						<Input name="lastName" id="lastName" placeholder="Doe" type="text" />
					</LabelInputContainer>
				</div>
				...
				<div className="flex flex-col space-y-4">
					...
					>
						...
						<span className="text-neutral-700 dark:text-neutral-300 text-sm">Continue with GitHub</span>
						<BottomGradient />
					</button>
					<button
						onClick={() => signUp?.authenticateWithRedirect({
